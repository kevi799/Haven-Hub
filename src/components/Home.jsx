...
const Home = () => {
  const containerStyle = {
    backgroundImage:
      'url("https://i.pinimg.com/736x/b3/b1/35/b3b135af9c4ddc2ec80f7947064016a6.jpg")',
    ...
    >
      <div style={containerStyle}>
        ...
        <p style={subtitleStyle}>
          Explore Haven Hub's mission, values, and innovative solutions for all
          your online real estate needs.
        </p>
      </div>
      ...
      <footer style={footerStyle}>
        ...
        >
          Achieving your home ownership dream is easier when you work with Haven
          Hub.
        </div>
